...
2. OpenAI analyzes the topic and self-assessment and returns one word: Anfänger, Fortgeschritten, or Experte
...
5. If the OpenAI API fails, a Fehlerbericht email is sent instead
